...
ActiveRecord::Schema[7.2].define(version: 2024_12_23_152348) do
  create_table "ingredient_recipes", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "ingredients", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["input"], name: "index_ingredients_on_input", unique: true
